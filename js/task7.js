...
window.onload = function() {
    ...
    let previousOperandTextElement = document.querySelector(".calculator__previous-value");
    let currentOperandTextElement = document.querySelector(".calculator__current-value");
